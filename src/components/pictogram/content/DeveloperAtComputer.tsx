...
import { AppDispatchContext, AppStateContext } from "@/context/context";
    ...
    state.lightsOff ?
      ...
      >
        ...
        <path
          ...
          fill="#f2f2f2"
        />
        <path d="M815.016 219.191 C 814.146 218.611 813.266 218.061 812.396 217.501 C 787.247 201.417 760.291 188.35 732.086 178.571 C 732.086 178.571 635.395 141.318 524.676 166.521 C 522.036 167.091 470.436 182.761 470.436 182.761 C 441.451 193.877 413.933 208.496 388.496 226.291 C 388.056 226.591 387.616 226.901 387.186 227.201 C 384.976 228.751 382.796 230.331 380.626 231.931 L 380.626 576.121 L 498.896 576.121 L 820.266 576.121 L 820.266 222.671 C 818.526 221.491 816.776 220.331 815.016 219.191 Z"
          transform="translate(-206.59003 -163.87113)"
          fill="#040404"
          style={{ cursor: 'pointer' }}
          onClick={() => dispatch({ type: AppReducerActionType.SET_LIGHTS_OFF, payload: false })} />
        <path
      ...
      >
        ...
        <path
          ...
          fill="#1F1A3B"
          style={{ cursor: 'pointer' }}
          onClick={() => dispatch({ type: AppReducerActionType.SET_LIGHTS_OFF, payload: true })}
        />
        <path
          d="M206.59,598.16193a289.0029,289.0029,0,0,0,28.12,28.95l730.58,1a289.0029,289.0029,0,0,0,28.12-28.95Z"
          transform="translate(-206.59003 -163.87113)"
